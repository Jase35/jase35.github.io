...
function Navbar() {
  return (
    <div className="fixed z-50 shadow-md flex flex-col xl:flex-row xl:justify-between absolute bg-main w-full right-0 left-0 top-0 pl-2">
        <div>
            <NavLink to="/" className="head-text-theme text-center xl:absolute top-2 left-4">Jase A. Beaubien</NavLink>
        </div>
        <nav className="justify-center items-center w-full xl:w-auto">
            <ul style={{ listStyle: 'none', display: 'flex', gap: '0px' }} className="w-full justify-between xl:w-auto xl:justify-center xl:items-center">
